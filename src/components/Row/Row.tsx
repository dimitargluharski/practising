...
const Row = ({ fixture, teams, goals }: Fixture) => {
    return (
        <div className="flex items-center shadow-lg rounded-md p-2 my-1 w-full bg-slate-600 text-white hover:bg-slate-900 hover:scale-105 transition-all ease-linear">
            <div className="mx-5">
